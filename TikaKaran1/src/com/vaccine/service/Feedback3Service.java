 ...
 * @author
 */
public class Feedback3Service {
  private static Logger log = Logger.getLogger(Feedback3Service.class.getCanonicalName());

  //mail id from which the mail has to be sent
  private static String fromAddress = "kunal.dhawan14@gmail.com";
